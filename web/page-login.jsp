...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>NuCars Locação - Login </title>
        ...
        <div class="container">
            <div class="area-login">
                <form method="post" accept-charset="UTF-8" action="">
                    ...
                    <input type="text" placeholder="Insira o CPF" name="login" id="login">

                    <label for="password">Senha</label>
                    <input type="password" placeholder="Senha" name="senha-login" id="senha-login">
                    <i id="olho" onclick="MostraSenha()" class="fas fa-eye"></i>
                    <p style="color: white; margin: 15px 0 -25px 0;">
                        <% String usuario = request.getParameter("login");
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from cliente where CPF = '" + usuario + "' and Senha = '" + senha + "'");
                                while (rs.next()) {
                                    user = rs.getString(3);
                                    pass = rs.getString(8);
                                    nomeUsuario = rs.getString(2); // confirmar a coluna nome que está no banco.
                                ...
                                rc = st.executeQuery("SELECT COUNT(*) FROM cliente");
                                rc.next();
                ...
                <p><a href="cadastro.jsp">Ainda não sou cliente</a></p>
            </div>
        </div>       
