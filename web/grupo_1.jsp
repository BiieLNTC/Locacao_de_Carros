        ...
        <div class=" row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <h5 class="card-title fw-bold m-2">Grupo A</h5>
                        <p class="card-title fw-bold m-3">UP 1.0, Kwid 1.0, Mobi 1.0</p>
                        <button type="submit" name="GrupoA" value="GrupoA" class="btn btn-reservar-car">Reserve</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <h5 class="card-title fw-bold m-2">Grupo B</h5>
                        <p class="card-title fw-bold m-3">Gol 1.6, Onix 1.6, HB20 1.6</p>
                        <a href="index.jsp" class="btn btn-reservar-car">Reserve</a>
                    </div>
                </div>
            </div>
